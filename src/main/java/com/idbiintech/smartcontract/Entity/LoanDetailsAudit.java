...
@Entity
@Table(name="LOAN_DET_AUDIT")
public class LoanDetailsAudit {
	...
	public String toString() {
		return "LoanDetailsAudit [loanmstId=" + loanmstId + ", loanCategory=" + loanCategory + ", customerId="
				+ customerId + ", loandetId=" + loandetId + ", loanAmount=" + loanAmount + ", loanInterest="
				+ loanInterest + ", loanDuration=" + loanDuration + ", loanproposalDate=" + loanproposalDate
				+ ", loanPurpose=" + loanPurpose + ", loanStatus=" + loanStatus + ", smartcontractPath="
				+ smartcontractPath + ", getLoanmstId()=" + getLoanmstId() + ", getLoanCategory()=" + getLoanCategory()
				+ ", getCustomerId()=" + getCustomerId() + ", getLoandetId()=" + getLoandetId() + ", getLoanAmount()="
				+ getLoanAmount() + ", getLoanInterest()=" + getLoanInterest() + ", getLoanDuration()="
				+ getLoanDuration() + ", getLoanproposalDate()=" + getLoanproposalDate() + ", getLoanPurpose()="
				+ getLoanPurpose() + ", getLoanStatus()=" + getLoanStatus() + ", getSmartcontractPath()="
				+ getSmartcontractPath() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}

...
@Controller
@RequestMapping("/api")
public class HousingLoanAgreementController {
	...
	public ResponseEntity<?> generatePdf(@RequestParam Map<String, String> map) throws IOException {
		...
		String plotno = map.get("plotno");
		String plotaddress = map.get("plotaddress");
		String bankaddress = map.get("bankaddress");
		String bankname = map.get("bankname");
		String agreementyname = map.get("agreementyname");
